...
function dicey_register_blocks() {
	...
	$blocks = array(
		...
		'about' => array(
			...
			'template' => 'template-parts/static/about',
			'callback' => 'dicey_render_about',
			'attributes' => array(
				'hero_title' => array( 'type' => 'string' ),
				'hero_image' => array( 'type' => 'string' ),
				'nutrition_title' => array( 'type' => 'string' ),
				'nutrition_text' => array( 'type' => 'string' ),
				'nutrition_items' => array(
					'type' => 'array',
					'default' => dicey_about_defaults()['nutrition_items'],
				),
				'acquaintances_title' => array( 'type' => 'string' ),
				'acquaintances_lead' => array( 'type' => 'string' ),
				'acquaintances_paragraphs' => array(
					'type' => 'array',
					'default' => dicey_about_defaults()['acquaintances_paragraphs'],
				),
				'acquaintances_image' => array( 'type' => 'string' ),
				'team_title' => array( 'type' => 'string' ),
				'team_items' => array(
					'type' => 'array',
					'default' => dicey_about_defaults()['team_items'],
				),
				'choice_title' => array( 'type' => 'string' ),
				'choice_items' => array(
					'type' => 'array',
					'default' => dicey_about_defaults()['choice_items'],
				),
				'nature_image' => array( 'type' => 'string' ),
				'nature_title' => array( 'type' => 'string' ),
				'nature_paragraphs' => array(
					'type' => 'array',
					'default' => dicey_about_defaults()['nature_paragraphs'],
				),
				'partnership_title' => array( 'type' => 'string' ),
				'partnership_subtitle' => array( 'type' => 'string' ),
				'partnership_text' => array( 'type' => 'string' ),
				'partnership_button_label' => array( 'type' => 'string' ),
