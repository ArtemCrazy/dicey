...
<footer>
    <div class="container">
        ...
        <div class="footer__info">
            <a href="/" class="footer__logo"><img src="static/imgs/icons/logo2.svg" alt="Логотип"></a>
            ...
            <form class="footer__form">
                ...
                <label class="checkbox__parent">
                    ...
                    <p class="consult__text">
                        Я даю <a href="#">согласие на получение рекламной информации</a> о поступлении новых товаров, скидках и распродажах посредством электронной почты
                    </p>
                  </label>
            </form>
        </div>
        ...
        <div class="footer__bottom">
            <div class="footer__links">
                ...
                <a href="#">Согласие на получение информационной и рекламной рассылки</a>
                <a href="#">Согласие об обработки персональных данных</a>
