( function ( blocks, element, components, i18n, data, blockEditor ) {
	...
	var defaults = {
		...
		'dietology': {
			...
			consult_items: [
				...
				{ icon: 'imgs/bg/consultation__img5.svg', icon_mobile: 'imgs/bg/consultation__img7.svg', text: 'Собака с пищевой аллергией или непереносимостью' },
			...
			advisory_steps: [
				...
				{ title: 'Диетолог проводит консультацию', text: 'Изучаем особенности вашей собаки, отвечаем на вопросы и уточняем все особенности питания собаки', icon: 'imgs/icons/advisory__icon2.svg' },
			...
			faq_items: [
				...
				{ question: 'Можно ли кормить этими рационами собаку с пищевой аллергией или чувствительным пищеварением?', answer: '' },
	...
	function saleEdit( props ) {
		...
		return box( 'Скидка - 15% на первый заказ', [
